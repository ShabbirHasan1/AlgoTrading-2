# -*- coding: utf-8 -*-
"""
Created on Sun Jul  5 15:04:50 2020
...
#tickers = ["RELIANCE.NS","TATAMOTORS.NS","IBULHSGFIN.NS","ITC.NS","AXISBANK.NS","ICICIBANK.NS","INFY.NS","TSLA","INDIGO.NS","BANDHANBNK.NS"]
tickers = ["RELIANCE.NS"]
ohlc_intraday = {} # directory with ohlc value for each stock            
key_path =  "D:\AlgoTr\AlphaVAPI.txt"
...
while len(tickers) != 0 and attempt <=5:
    ...
    for i in range(len(tickers)):
        try:
            ...
            ohlc_intraday[tickers[i]]  = ts.get_intraday(symbol= tickers[i], interval='15min',outputsize='compact')[0]
            api_count += 1
          ...
          #  ohlc_intraday[tickers[i]] = ts.get_intraday(symbol=tickers[i],interval='60min', outputsize='compact')[0]
          #  ohlc_intraday[tickers[i]].columns = ["Open","High","Low","Adj Close","Volume"]
          #  drop.append(tickers[i])      
        except:
